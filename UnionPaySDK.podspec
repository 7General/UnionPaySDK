...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/wanghuizhou21@163.com/UnionPaySDK'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'wanghuizhou21@163.com' => 'wanghuizhou@guazi.com' }
  s.source           = { :git => 'https://github.com/wanghuizhou21@163.com/UnionPaySDK.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'UnionPaySDK' => ['UnionPaySDK/Assets/*.png']
  # }
